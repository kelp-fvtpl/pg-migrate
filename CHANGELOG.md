...
We need to set TENANT*CODE in environment(may be via .env)
if the file name has for format like <SerialNumber>*<Description>.{sql/js} we would execute it without any checks.
